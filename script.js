...
function connect(){if(socket&&socket.readyState===WebSocket.OPEN)return;socket=new WebSocket('wss://go-meta-ball-2026.onrender.com/');socket.onmessage=e=>handle(JSON.parse(e.data));socket.onclose=()=>toast('서버 연결 종료.');}
